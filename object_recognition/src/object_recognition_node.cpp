...
void visualize_marker (pcl::PointCloud<pcl::PointXYZ>::Ptr a_cloud_cluster, visualization_msgs::Marker::Ptr a_marker, int a_marker_id)
{
...
//int correlation_spin_images (pcl::PointCloud<pcl::Histogram<153> >::Ptr a_spin_images1, pcl::PointCloud<pcl::Histogram<153> > &a_spin_images2)
//{
//	float R;
//	int histo_size = 153;
...
//		{
//			R=((histo_size*std::inner_product(std::begin(a_spin_images1->points[i].histogram),
//												std::end(a_spin_images1->points[i].histogram),
//												std::begin(a_spin_images2.points[j].histogram),
//												0))
//					-(std::accumulate(std::begin(a_spin_images1->points[i].histogram),
//										std::end(a_spin_images1->points[i].histogram),
//										0)
//						*std::accumulate(std::begin(a_spin_images1->points[i].histogram),
//											std::end(a_spin_images1->points[i].histogram),
//											0)))/
//			(std::sqrt(((histo_size*std::inner_product(std::begin(a_spin_images1->points[i].histogram),
//														std::end(a_spin_images1->points[i].histogram),
//														std::begin(a_spin_images1->points[j].histogram),
//														0))
//						-(std::pow(std::accumulate(std::begin(a_spin_images1->points[i].histogram),
//													std::end(a_spin_images1->points[i].histogram),
//													0)
//									,2)))
//					*((histo_size*std::inner_product(std::begin(a_spin_images2.points[i].histogram),
//														std::end(a_spin_images2.points[i].histogram),
//														std::begin(a_spin_images2.points[j].histogram),
//														0))
//						-(std::pow(std::accumulate(std::begin(a_spin_images2.points[i].histogram),
//													std::end(a_spin_images2.points[i].histogram),
//													0)
//									,2)))));
//		}
...
//	  }
	  ...
	  visualize_marker((*cloud_cluster)[i], marker, i);
